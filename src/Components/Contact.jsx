...
const Contact = () => {
  ...
  return (
    <div id="contact" className="flex flex-col items-center justify-center gap-20 my-28 max-md:items-start max-md:mx-10 max-md:gap-14">
        <div className="relative">
            <h1 className="text-6xl font-semibold text-center max-md:text-5xl">Get in touch</h1>
            <img src={theme_pattern} alt="theme" className="absolute h-14 top-3 left-44 -z-10 max-md:h-10 max-md:left-44"/>
        </div>
        ...
        <div className="flex justify-center gap-32 max-md:flex-col max-md:gap-20">
            <div className="flex flex-col gap-9 w-1/3 max-md:w-[70vw]">
                <h1 className="text-5xl font-semibold bg-custom-gradient-contact backdrop-bg-clip-text">{`Let's talk`}</h1>
            ...
            <form className="flex flex-col items-start gap-3 w-1/2 max-md:w-full" onSubmit={onSubmit}>
                ...
                <input type="text" placeholder="Enter Your Name" name="name" className="border-none w-full h-16 pl-5 rounded-md bg-[#32323c] placeholder:opacity-60 placeholder:text-lg text-[#A0A0A0] max-md:w-[90vw]"/>
                <label className="text-slate-200 text-md font-medium">Your Email</label>
                <input type="email" placeholder="Enter Your Email" name="email" className="border-none w-full h-16 pl-5 rounded-md bg-[#32323c] placeholder:opacity-60 placeholder:text-lg text-[#A0A0A0] max-md:w-[90vw]"/>
                <label htmlFor="" className="text-slate-200 text-md font-medium">Write Your Message </label>
                <textarea name="message" rows="8" placeholder="Enter Your Message" className="border-none w-full pl-5 pt-5 rounded-md bg-[#32323c] placeholder:opacity-60 placeholder:text-lg text-[#A0A0A0]max-md:w-[90vw]"></textarea>
